# AGENTS.md — happy-wakey/happy-wakey-mcp-server.rs
...
- Repository: [`happy-wakey/happy-wakey-mcp-server.rs`](https://github.com/happy-wakey/happy-wakey-mcp-server.rs)
- Local checkout: `~/codes/happy-wakey/happy-wakey-mcp-server.rs`
...
- Sibling test org: `github.com/happy-wakey-test` (external/e2e coverage and extra GHA minutes)
...
- Package / service name: `happy-wakey-mcp-server`
